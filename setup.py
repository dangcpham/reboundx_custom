...
class build_ext(_build_ext):
    def finalize_options(self):
        ...
        sources = [ 'src/interpolation.c', 'src/gr_potential.c', 'src/yarkovsky_effect.c', 'src/tides_constant_time_lag.c', 'src/integrator_rk2.c', 'src/modify_mass.c', 'src/lense_thirring.c', 'src/modify_orbits_forces.c', 'src/radiation_forces.c', 'src/stochastic_forces.c', 'src/planet_force.c', 'src/star_planet_galactic_tide.c', 'src/tides_spin.c', 'src/steppers.c', 'src/track_min_distance.c', 'src/inner_disk_edge.c', 'src/central_force.c', 'src/output.c', 'src/gravitational_harmonics.c', 'src/input.c', 'src/exponential_migration.c', 'src/core.c', 'src/integrator_euler.c', 'src/galactic_tidal_force.c', 'src/linkedlist.c', 'src/integrator_implicit_midpoint.c', 'src/gr.c', 'src/type_I_migration.c', 'src/gr_full.c', 'src/integrate_force.c', 'src/gas_dynamical_friction.c', 'src/modify_orbits_direct.c', 'src/rebxtools.c', 'src/integrator_rk4.c'],
